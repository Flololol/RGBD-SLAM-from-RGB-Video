...
from superpoint.superpoint import PointTracker
from superpoint.superpoint import VideoStreamer
...
if __name__ == '__main__':
  ...
  parser.add_argument('--input', type=str, default='superpoint/inputs/',
      help='Image directory or movie file or "camera" (for webcam).')
  parser.add_argument('--weights_path', type=str, default='superpoint/superpoint_v1.pth',
      help='Path to pretrained weights file (default: superpoint/superpoint_v1.pth).')
  ...
  parser.add_argument('--write_dir', type=str, default='superpoint/outputs/',
      help='Directory where to write output frames (default: superpoint/outputs/).')
