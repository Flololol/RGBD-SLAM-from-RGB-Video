\chapter{Method}
    ...
    \section{Pose Optimization}
        ...
        % \begin{figure}[ht]
            % \centering
            % \begin{subfigure}[b]{width=.2\linewidth}
            %     \includegraphics[width=.2\linewidth]{images/vis_perspective_01}
            %     \label{fuckoff}
            %     \caption[]{fuckoff}
            % \end{subfigure}
            % \begin{subfigure}[b]{width=.45\textwidth}
            %     \includegraphics[width=.45\textwidth]{images/vis_perspective_02}
            % \end{subfigure}
            % \begin{subfigure}[b]{width=.45\textwidth}
            %     \includegraphics[width=.45\textwidth]{images/vis_perspective_03}
            % \end{subfigure}
        %     \caption[]{~\sref{} displays the normal image $i$. }
